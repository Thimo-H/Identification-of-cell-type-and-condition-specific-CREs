...
uploading Seurat object
```{r read counts data, message=FALSE, warning=FALSE}
seurat.data <- readRDS("~/OBM_Ara_root_benchmark.rds")
...
```
uploading cis-element list
```{r cis element list}
nn_list <- readRDS("~/TGTCNN_repeats0_4__motif.Rdata")
...
saveRDS(seurat.data, "~/OBM_TGTCNN_0_4_.rds")
```
...
saveRDS(markers, "~/OBM_TGTCNN_0_4_genemarkers_0.25.rds")
